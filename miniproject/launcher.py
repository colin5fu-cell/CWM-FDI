...
model1_result = subprocess.run([sys.executable, "logistic_new.py"], capture_output = True, text = True)
model1_energy = subprocess.run(["sudo", "turbostat", "--Summary", "--quiet", "--Joules", "--show", "Pkg_J", sys.executable, "logistic_new.py"], capture_output = True, text = True)
...
model2_result = subprocess.run([sys.executable, "forest_new.py"], capture_output = True, text = True)
model2_energy = subprocess.run(["sudo", "turbostat", "--Summary", "--quiet", "--Joules", "--show", "Pkg_J", sys.executable, "forest_new.py"], capture_output = True, text = True)
...
model3_result = subprocess.run([sys.executable, "gradientboost_new.py"], capture_output = True, text = True)
model3_energy = subprocess.run(["sudo", "turbostat", "--Summary", "--quiet", "--Joules", "--show", "Pkg_J", sys.executable, "gradientboost_new.py"], capture_output = True, text = True)
...
model4_result = subprocess.run([sys.executable, "SGD_new.py"], capture_output = True, text = True)
model4_energy = subprocess.run(["sudo", "turbostat", "--Summary", "--quiet", "--Joules", "--show", "Pkg_J", sys.executable, "SGD_new.py"], capture_output = True, text = True)
...
for i in range(len(nor_recall)):
    nor_recall[i] = (recall1[i] - min_recall) / (max_recall - min_recall)
